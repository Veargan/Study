            ...
            try
            {
                while (true)
                {
                    ...
                    if (new Regex("^get").IsMatch(header))
                    {
                        ...
                        if (cl == null)
                            connectionList.AddClient(new Client(input[0], connectedClient, 0));
                        else
                            Write("alreadyinside", 0, connectedClient);
                        #region trash
                        //if (input[0] == "restore")
                        //{
                        //    if (db.SendPassword(input[1], input[2]))
                        //    {
                    ...
                    else
                    {
                        ...
                        Client cl = connectionList.clientList.Find(c => c.name == input[0]);
                        if (cl == null)
                            connectionList.AddClient(new Client(input[0], connectedClient, 1));
                        else
                            Write("alreadyinside", 0, connectedClient);
                        #region trash
                        //if (input[0] == "restore")
