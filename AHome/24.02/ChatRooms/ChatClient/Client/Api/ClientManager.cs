...
namespace Client
{
    public class ClientManager
    {
        ...
        public void Connect(string name, string pass, LoginForm log)
        {
            ...
            receiveThread.Start();
            SendLoginInfo(name, pass);
            this.log = log;
        }

        void SendLoginInfo(string name, string pass)
        {
            StreamWriter sw = new StreamWriter(netStream);
            sw.WriteLine(name + "^" + pass + "^0^auth");
            sw.Flush();
        }
