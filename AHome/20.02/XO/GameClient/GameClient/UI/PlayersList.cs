...
namespace GameClient
{
    public partial class PlayersList : Form
    {
        ...
        public void AddList(string[] items)
        {
            ...
            this.Invoke(new Action(() => { this.Text = name; }));
        }

        public void DelFromList(string item)
        {
            lbPlayers.Invoke(new Action(() => { lbPlayers.Items.Remove((string)item); }));
        }
        ...
        {
            if (name != lbPlayers.SelectedItem.ToString())
            {
