package com.example.sony.sqlitecrud;

import com.example.sony.sqlitecrud.db.SQLiteDBHelper;
...
public class Config
{
    public static final String DB_NAME = "Person Data Dase";
    ...
    public static final String COMMAND_SELECTED = "SELECT * FROM "+TABLE_PERSON;
